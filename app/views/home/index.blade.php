	...
	<div class="row">
		<div class="large-12 columns content">
			...
			<div id="container">
				<ul>
					@for ($i = 1; $i <= 6; $i++)
						<li><a href="{{ URL::to('images/screenshots/img' . $i . '.jpg') }}" data-imagelightbox data-no-instant>{{ HTML::image('images/screenshots/img' . $i . '-th.jpg', null, ["class" => 'image-hover']) }}</a></li>
					@endfor
				</ul>
